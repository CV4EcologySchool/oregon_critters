...
## SPLIT (TRAIL) ------------------------------------------------------------
  ...
  #now choose cameras/photos for each species (in order of priority in case there are conflicting cameras):
  dat$group <- rep(NA, nrow(dat))
  
  rare_sp
  
  #--Pileated Woodpecker
  dat[dat$sp %in% 'PileatedWoodpecker',]$full_path_new #only 1 sequence put in 'train'
  dat$group <- ifelse(dat$CName %in% 'PileatedWoodpecker', 'train', dat$group)
  
  #--Herp 
  dat[dat$sp %in% 'Herp',]$full_path_new #only 1 sequence put in 'train'
  dat$group <- ifelse(dat$CName %in% 'RedFox', 'train', dat$group)
  
  #--Red Fox 
  dat[dat$CName %in% 'RedFox',]$full_path_new #only 1 sequence put in 'train'
  dat$group <- ifelse(dat$CName %in% 'Herp', 'train', dat$group)
  
  
  #--Ground Squirrel
  dat[dat$sp %in% 'GroundSquirrel',]$full_path_new 
  dat$group <- ifelse(dat$full_path_new %in% c("data/DUNES/hailey.hester-DUNES_GroundSquirrel/images/DUNE5A_IMG_1126_bz.JPG",                    
                                               "data/DUNES/hailey.hester-DUNES_GroundSquirrel/images/DUNE5A_IMG_1127_bz.JPG",                    
                                               "data/DUNES/hailey.hester-DUNES_GroundSquirrel/images/DUNE5A_IMG_1128_bz.JPG",                    
                                               "data/DUNES/hailey.hester-DUNES_GroundSquirrel/images/DUNE5B_IMG_0172_bz.JPG",                    
                                               "data/DUNES/hailey.hester-DUNES_GroundSquirrel/images/DUNE5B_IMG_0173_bz.JPG",                    
                                               "data/DUNES/hailey.hester-DUNES_GroundSquirrel/images/DUNE5B_IMG_0225_bz.JPG",                    
                                               "data/DUNES/hailey.hester-DUNES_GroundSquirrel/images/DUNE5B_IMG_0289_bz.JPG",                    
                                               "data/DUNES/hailey.hester-DUNES_GroundSquirrel/images/DUNE5B_IMG_0290_bz.JPG",                    
                                               "data/DUNES/hailey.hester-DUNES_GroundSquirrel/images/DUNE5B_IMG_0291_bz.JPG"), 'train', 
                      ifelse(dat$full_path_new %in% c("data/ORSNAP/hailey.hester-ORSNAP_GroundSquirrel/images/ORSNAP10__2022-09-28__14-34-12(1)_ay.JPG"), 'val', dat$group))

  #--Bat
  dat[dat$sp %in% 'Bat',]$full_path_new 
  dat$group <- ifelse(dat$full_path_new %in% c("data/COA_2019/COA2019_Bat/images/10316-5__2019-08-05__04-43-55(1)_ho.JPG",
                                               "data/COA_2019/COA2019_Bat/images/10831-1__2019-08-07__01-08-48(7)_ho.JPG",
                                               "data/COA_2019/COA2019_Bat/images/8749-3__2019-07-19__00-53-50(1)_ho.JPG", 
                                               "data/COA_2019/COA2019_Bat/images/8749-3__2019-07-19__00-53-51(2)_ho.JPG", 
                                               "data/COA_2019/COA2019_Bat/images/8749-3__2019-07-19__04-01-21(1)_ho.JPG"), 'train', 
                      ifelse(dat$full_path_new %in% c("data/COA_2019/COA2019_Bat/images/9475-5__2019-08-05__04-39-39(2)_ho.JPG", 
                                                      "data/COA_2019/COA2019_Bat/images/9475-5__2019-08-05__04-39-40(3)_ho.JPG"), 'val',
                             ifelse(dat$full_path_new %in% c("data/COA_2019/COA2019_Bat/images/10831-1__2019-08-07__01-08-48(7)_ho.JPG",
                                                             "data/COA_2019/COA2019_Bat/images/10831-1__2019-08-07__01-08-48(7)_ho.JPG"), 'test',dat$group)))
  
  #--Mink
  dat[dat$sp %in% 'Mink',]$full_path_new 
  dat$group <- ifelse(dat$full_path_new %in% c("data/HJA_MARIE/hailey.hester-HJA_MARIE_Mink/images/Hobo-347_2017-08-16_IMG_0013_cr.JPG",
                                               "data/HJA_MARIE/hailey.hester-HJA_MARIE_Mink/images/Hobo-347_2017-08-16_IMG_0014_cr.JPG",
                                               "data/HJA_MARIE/hailey.hester-HJA_MARIE_Mink/images/Hobo-347_2017-08-16_IMG_0015_cr.JPG",
                                               "data/HJA_MARIE/hailey.hester-HJA_MARIE_Mink/images/Hobo-347_2018-09-27_IMG_0052_cr.JPG",
                                               "data/HJA_MARIE/hailey.hester-HJA_MARIE_Mink/images/Hobo-347_2018-09-27_IMG_0053_cr.JPG",
                                               "data/HJA_MARIE/hailey.hester-HJA_MARIE_Mink/images/Hobo-347_2018-09-27_IMG_0054_cr.JPG"), 'train', 
                      ifelse(dat$full_path_new %in% c("data/HJA_MARIE/hailey.hester-HJA_MARIE_Mink/images/HOBO-211_2018-01-23_IMG_0217_cr.JPG",
                                                      "data/HJA_MARIE/hailey.hester-HJA_MARIE_Mink/images/HOBO-211_2018-01-23_IMG_0218_cr.JPG",
                                                      "data/HJA_MARIE/hailey.hester-HJA_MARIE_Mink/images/HOBO-211_2018-01-23_IMG_0219_cr.JPG"), 'val', 
                             ifelse(dat$full_path_new %in% c("data/HJA_MARIE/hailey.hester-HJA_MARIE_Mink/images/HOBO-016_2017-12-24_IMG_0004_cr.JPG"), 'test',dat$group)))
  
  #--Owl
  dat[dat$CName %in% 'Owl',]$full_path_new 
  dat$group <- ifelse(dat$full_path_new %in% c("data/ESF_BAIT/hailey.hester-ESF_BAIT_Owl/images/18909B_bait_0028_dc.JPG",              
                                               "data/ESF_BAIT/hailey.hester-ESF_BAIT_Owl/images/18909B_bait_0029_dc.JPG",              
                                               "data/ESF_BAIT/hailey.hester-ESF_BAIT_Owl/images/18909B_bait_0030_dc.JPG",              
                                               "data/ESF_BAIT/hailey.hester-ESF_BAIT_Owl/images/19008A_bait_0049_dc.JPG",              
                                               "data/ESF_BAIT/hailey.hester-ESF_BAIT_Owl/images/19008A_bait_0050_dc.JPG",              
                                               "data/ESF_BAIT/hailey.hester-ESF_BAIT_Owl/images/19008A_bait_0051_dc.JPG",
                                               "data/COA_2021/cappel-COA_2021_Grouse1_ZF/images/21106-4__21106-4-T__2021-05-13__05-37-43(1)_hc.JPG",
                                               "data/COA_2021/cappel-COA_2021_Grouse1_ZF/images/21106-4__21106-4-T__2021-05-13__05-37-43(2)_hc.JPG",
data/COA_2019/hailey.hester-COA2019_CanadaJay/images/9476-1__2019-08-16__12-54-35(1)_hj.JPG"), 'train', 
                      ifelse(dat$full_path_new %in% c("data/HJA_GRID/hailey.hester-HJA_GRID_CanadaJay/images/GRID_02_02__GRID_02_02_2020__2020-04-08__15-03-26(1)_ae.JPG",
                                                      "data/HJA_GRID/hailey.hester-HJA_GRID_CanadaJay/images/GRID_02_02__GRID_02_02_2020__2020-04-08__15-03-27(2)_ae.JPG",
                                                      "data/HJA_GRID/hailey.hester-HJA_GRID_CanadaJay/images/GRID_02_02__GRID_02_02_2020__2020-04-08__15-03-28(3)_ae.JPG",
                                                      "data/HJA_GRID/hailey.hester-HJA_GRID_CanadaJay/images/GRID_02_02__GRID_02_02_2021__2021-06-28__16-07-11(1)_ae.JPG",
                                                      "data/HJA_GRID/hailey.hester-HJA_GRID_CanadaJay/images/GRID_02_02__GRID_02_02_2021__2021-06-28__16-07-12(2)_ae.JPG",
                                                      "data/HJA_GRID/hailey.hester-HJA_GRID_CanadaJay/images/GRID_02_02__GRID_02_02_2021__2021-06-28__16-07-13(3)_ae.JPG"), 'val',
                             ifelse(dat$full_path_new %in% c("data/COA_2019/hailey.hester-COA2019_CanadaJay/images/7619-3__2019-08-08__15-16-10(1)_hj.JPG",                     
                                                             "data/COA_2019/hailey.hester-COA2019_CanadaJay/images/7619-3__2019-08-08__15-16-11(2)_hj.JPG",                      
                                                             "data/COA_2019/hailey.hester-COA2019_CanadaJay/images/7619-3__2019-08-08__15-16-12(3)_hj.JPG",
                                                             "data/HJA_GRID/hailey.hester-HJA_GRID_CanadaJay/images/GRID_05_05A__2019-09-28__16-38-19(1)_ae.JPG",                
                                                             "data/COA_2019/hailey.hester-COA2019_CanadaJay/images/8749-2__2019-07-20__07-21-15(1)_hj.JPG"), 'test',dat$group)))
 
  #--Woodpecker
  dat[dat$sp %in% 'Woodpecker',]$full_path_new 
  dat$group <- ifelse(dat$full_path_new %in% c("data/COA_2019/hailey.hester-COA2019_Woodpecker/images/10460-3__2019-07-18__07-15-38(3)_hy.JPG",     
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/11419-3__2019-09-03__12-13-49(1)_hy.JPG",     
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/11419-3__2019-09-03__12-13-51(2)_hy.JPG",     
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/11419-3__2019-09-03__12-13-52(3)_hy.JPG",     
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/7619-4__2019-07-31__15-07-22(1)_hy.JPG",      
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/7619-4__2019-07-31__15-07-23(2)_hy.JPG",      
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/7619-4__2019-07-31__15-07-24(3)_hy.JPG",      
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/8494-1__2019-07-19__16-54-32(1)_hy.JPG",      
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/8494-1__2019-07-19__16-54-32(2)_hy.JPG",      
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/8494-1__2019-07-19__16-54-33(3)_hy.JPG",      
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/8644-3__2019-09-17__09-22-14(2)_hy.JPG",      
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/8907-3__2019-08-06__08-56-40(1)_hy.JPG",      
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/8907-3__2019-08-06__08-56-41(2)_hy.JPG",      
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/8907-3__2019-08-06__08-56-42(3)_hy.JPG",      
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/9927-2__2019-07-30__10-04-33(1)_hy.JPG",      
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/9927-2__2019-07-30__10-04-34(2)_hy.JPG",      
                                               "data/COA_2019/hailey.hester-COA2019_Woodpecker/images
data/COA_2019/hailey.hester-COA2019_Woodpecker/images/10171-4__2019-08-19__09-53-52(3)_hy.JPG",     
                                                      "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/10316-3__2019-07-21__19-27-37(2)_hy.JPG",     
                                                      "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/10316-3__2019-07-21__19-27-38(3)_hy.JPG"), 'val',
                             ifelse(dat$full_path_new %in% c("data/COA_2019/hailey.hester-COA2019_Woodpecker/images/10460-2__2019-07-10__19-04-37(2)_hy.JPG",     
                                                             "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/10460-2__2019-07-10__19-04-38(3)_hy.JPG",     
                                                             "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/10460-3__2019-07-17__09-21-30(1)_hy.JPG",     
                                                             "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/10460-3__2019-07-17__09-21-31(2)_hy.JPG",     
                                                             "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/10460-3__2019-07-17__09-21-32(3)_hy.JPG",     
                                                             "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/10460-3__2019-07-18__07-15-36(1)_hy.JPG",     
                                                             "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/10460-3__2019-07-18__07-15-37(2)_hy.JPG",     
                                                             "data/COA_2019/hailey.hester-COA2019_Woodpecker/images/10460-3__2019-07-18__07-15-38(3)_hy.JPG"), 'test',dat$group)))
  ...
  #ok, not all of these have site names. how many do?
  dat_rest_cams <- unique(dat_rest[,c('full_path','site')]) #
  nrow(dat_rest_cams[!is.na(dat_rest_cams$site),]) #*do* have site
  nrow(dat_rest_cams[is.na(dat_rest_cams$site),])  #do not have site
  ...
  dat_rest_site$group <- dat_rest_site_cams$rand1[match(dat_rest_site$site, dat_rest_site_cams$site)]
  table(dat_rest_site$group, useNA = 'a')
  #actually this is close ish. 72/17/10
  ...
  #By images per species
  (species_totals_g <- dat_groups %>% group_by(CName, group) %>% summarise('nPhotos' = length(unique(full_path))))
  p1a <- ggplot(species_totals_g, aes(reorder(CName, -nPhotos), y = nPhotos)) +
    geom_bar(stat = 'identity', fill = '#619CFF') + coord_flip() + theme_bw() + theme(axis.title.y = element_blank()) +
    facet_grid(~group)
  p1
  ggsave('/Users/caraappel/Documents/CV4E/oregon_critters/figures/COA_species_trail_imgs_all.png', units="in", width=7, height=5, dpi=600, bg = 'transparent')
  p1a #all 7 red fox images are from the same sequence so don't really want to split it up
  ggsave('/Users/caraappel/Documents/CV4E/oregon_critters/figures/COA_species_trail_imgs_split.png', units="in", width=7, height=5, dpi=600, bg = 'transparent')
  ...
  p3a <- ggplot(species_project_g, aes(x = reorder(CName, -nPhotos, sum), y = nPhotos, fill = project)) +
    ...
    facet_grid( ~group)
  p3
  ggsave('figures/COA_species_trail_study_all.png', units="in", width=7, height=5, dpi=600, bg = 'transparent')
  p3a
  ggsave('figures/COA_species_trail_study_split.png', units="in", width=7, height=5, dpi=600, bg = 'transparent')    
  ...
  p4a <- ggplot(species_day_night_g, aes(x = reorder(CName, -nPhotos, sum), y = nPhotos, fill = day_night)) +
    ...
    facet_grid(~group)
  p4
  ggsave('figures/COA_species_trail_daynight_all.jpeg', units="in", width=7, height=5, dpi=600, bg = 'transparent')
  p4a
  ggsave('figures/COA_species_trail_daynight_split.png', units="in", width=7, height=5, dpi=600, bg = 'transparent')
  ...
  p5a <- ggplot(species_cam_type_g, aes(x = reorder(CName, -nPhotos, sum), y = nPhotos, fill = cam_type)) +
    ...
    facet_grid(~group)
  p5
  ggsave('figures/COA_species_trail_camtype_all.png', units="in", width=7, height=5, dpi=600, bg = 'transparent')
  p5a  
  ggsave('figures/COA_species_trail_camtype_split.png', units="in", width=7, height=5, dpi=600, bg = 'transparent')
  
  
  #save!
  write.csv(dat_groups, '/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_trail_180_split.csv')
  write.csv(dat_groups[dat_groups$group %in% 'train',], '/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_trail_180_train.csv')
  write.csv(dat_groups[dat_groups$group %in% 'val',], '/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_trail_180_val.csv')
  write.csv(dat_groups[dat_groups$group %in% 'test',], '/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_trail_180_test.csv')
  
  
  #save txt files with just filenames
  write.table(dat_groups[dat_groups$group %in% 'train',]$full_path_new, col.names = FALSE, row.names = FALSE,
              file = '/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_trail_180_train.txt')
  write.table(dat_groups[dat_groups$group %in% 'val',]$full_path_new, col.names = FALSE, row.names = FALSE,
              file = '/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_trail_180_val.txt')
  write.table(dat_groups[dat_groups$group %in% 'test',]$full_path_new, col.names = FALSE, row.names = FALSE,
              file = '/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_trail_180_test.txt')
  
### 
################################################################################
  
## BOTH B (GROUND + TRAIL COMBINED)  -------------------------------------------
  
  #How does it look if I just combine them with splits as-is?
  tr <- fread('/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_trail_180_split.csv')
  gr <- fread('/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_ground_620_split.csv')
  
    length(unique(tr$full_path_new)) #6074 trail
    length(unique(gr$full_path_new)) #6000 ground
    
    #Trail splits:
    length(unique(tr[tr$group %in% 'train',]$full_path_new)) #4413 train (73%)
    length(unique(tr[tr$group %in% 'val',]$full_path_new))   #945 trail (15%)
    length(unique(tr[tr$group %in% 'test',]$full_path_new))  #716 trail (12%)
    
    #Ground splits:
    length(unique(gr[gr$group %in% 'train',]$full_path_new)) #4261 train (71%)
    length(unique(gr[gr$group %in% 'val',]$full_path_new))   #770 trail (13%)
    length(unique(gr[gr$group %in% 'test',]$full_path_new))  #969 trail (16%)
    
    #Combine
    bothB <- bind_rows(tr,gr)
      length(unique(bothB$full_path_new)) #12074 (should be 6000 + 6074)
      
    #Combined splits:
    length(unique(bothB[bothB$group %in% 'train',]$full_path_new)) #8674 train (72%)
    length(unique(bothB[bothB$group %in% 'val',]$full_path_new))   #1715 trail (14%)
    length(unique(bothB[bothB$group %in% 'test',]$full_path_new))  #1685 trail (14%)
      #looks great!
  ...
  p1a <- ggplot(species_totals_g, aes(reorder(CName, -nPhotos), y = nPhotos, fill = group)) +
    ...
    facet_grid(~group)
  p1
  ggsave('figures/COA_species_bothB_imgs_all.png', units="in", width=7, height=5, dpi=600, bg = 'transparent')
  p1a #all 7 red fox images are from the same sequence so don't really want to split it up
  ggsave('figures/COA_species_trail_imgs_split.png', units="in", width=7, height=5, dpi=600, bg = 'transparent')
  ...
  p3a <- ggplot(species_project_g, aes(x = reorder(CName, -nPhotos, sum), y = nPhotos, fill = project)) +
    ...
    facet_grid( ~group)
  p3
  ggsave('figures/COA_species_bothB_study_all.png', units="in", width=7, height=5, dpi=600, bg = 'transparent')
  p3a
  ggsave('figures/COA_species_bothBl_study_split.png', units="in", width=7, height=5, dpi=600, bg = 'transparent')    
  ...
  p4a <- ggplot(species_day_night_g, aes(x = reorder(CName, -nPhotos, sum), y = nPhotos, fill = day_night)) +
    ...
    facet_grid(~group)
  p4
  ggsave('figures/COA_species_bothB_daynight_all.jpeg', units="in", width=7, height=5, dpi=600, bg = 'transparent')
  p4a
  ggsave('figures/COA_species_bothB_daynight_split.png', units="in", width=7, height=5, dpi=600, bg = 'transparent')
  ...
  p5a <- ggplot(species_cam_type_g, aes(x = reorder(CName, -nPhotos, sum), y = nPhotos, fill = cam_type)) +
    ...
    facet_grid(~group)
  p5
  ggsave('figures/COA_species_bothB_camtype_all.png', units="in", width=7, height=5, dpi=600, bg = 'transparent')
  p5a  
  ggsave('figures/COA_species_bothB_camtype_split.png', units="in", width=7, height=5, dpi=600, bg = 'transparent')
  
  
  #save!
  write.csv(dat_groups, '/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_bothB_split.csv')
  write.csv(dat_groups[dat_groups$group %in% 'train',], '/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_bothB_train.csv')
  write.csv(dat_groups[dat_groups$group %in% 'val',], '/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_bothB_val.csv')
  write.csv(dat_groups[dat_groups$group %in% 'test',], '/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_tbothB_test.csv')
  
  
  #save txt files with just filenames
  write.table(dat_groups[dat_groups$group %in% 'train',]$full_path_new, col.names = FALSE, row.names = FALSE,
              file = '/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_bothB_train.txt')
  write.table(dat_groups[dat_groups$group %in% 'val',]$full_path_new, col.names = FALSE, row.names = FALSE,
              file = '/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_bothB_val.txt')
  write.table(dat_groups[dat_groups$group %in% 'test',]$full_path_new, col.names = FALSE, row.names = FALSE,
              file = '/Users/caraappel/Documents/CV4E/oregon_critters/metadata_labels/sampled_ds_bothB_test.txt')
